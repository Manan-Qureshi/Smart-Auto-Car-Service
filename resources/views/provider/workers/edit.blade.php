...
<div class="container py-4" style="max-width:600px">
    <div class="glass-card p-4 rounded-4 shadow">
        <h4 class="fw-bold mb-4"><i class="fas fa-user-edit text-primary me-2"></i>Edit Worker</h4>
        ...
        <form action="{{ route('provider.workers.update', $worker) }}" method="POST">
            @csrf @method('PUT')
            ...
            <div class="mb-3">
                ...
                <input type="text" name="name" class="form-control rounded-3 @error('name') is-invalid @enderror"
                       required value="{{ old('name', $worker->name) }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="cnic" class="form-control rounded-3 @error('cnic') is-invalid @enderror"
                       placeholder="e.g. 3520212345671" maxlength="15" required value="{{ old('cnic', $worker->cnic) }}">
            ...
            <div class="mb-3">
                ...
                <textarea name="address" class="form-control rounded-3 @error('address') is-invalid @enderror"
                          rows="2">{{ old('address', $worker->address) }}</textarea>
            ...
            <div class="mb-3">
                ...
                <input type="email" name="email" class="form-control rounded-3 @error('email') is-invalid @enderror"
                       required value="{{ old('email', $worker->email) }}">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="experience_years" class="form-control rounded-3 @error('experience_years') is-invalid @enderror"
                       min="0" value="{{ old('experience_years', $worker->experience_years) }}">
            ...
            <div class="form-check form-switch mb-4">
                <input class="form-check-input" type="checkbox" name="is_available" id="availSwitch"
                       {{ $worker->is_available ? 'checked' : '' }}>
